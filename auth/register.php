<?php
	...
	if(isset($_POST['register'])) {
		...
		try {
			...
			//turning off verification of the certificate
			...
			//end of turning off verification of the certificate  
		    ...
		    //Recipients
		    $mail->setFrom('xxx@gmail.com', 'Mailer XXXX');
			$mail->addAddress($email, $fullname);     // Add a recipient

		    //Content
		    $mail->isHTML(true);                                  // Set email format to HTML
		    $mail->Subject = "Registration successfull $fullname";
		    $mail->Body    = "Credentials for login into our site <br> Name: $fullname <br>Email : $email<br> Username: $username <br>Password: $password";
